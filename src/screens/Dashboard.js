...
import Main from "./adminScreens/Main";
import AddTransportRoutes from "./adminScreens/AddTransportRoutes";
import AddTransportTypes from "./adminScreens/AddTransportTypes";
      ...
      <Box sx={{ display: "flex", flexGrow: 1 }}>
        ...
        >
          <Routes>
            ...
            <Route path="addRoutes" element={<AddTransportRoutes />} />
            <Route path="addTypes" element={<AddTransportTypes />} />
          </Routes>
        </Box>
      </Box>
    </div>
